...
- Cards show **opening hours** where known (outdoor spaces are "open all year, dawn to
  ...
  **🍼 baby change** flags where confirmed. Beach listings show **⚠️ seasonal rules**
  where a byelaw restricts dogs (e.g. "Dogs excluded from the main beach, 1 May – 30
  September") — only added where verified. A `phone` column is ready in the schema but
