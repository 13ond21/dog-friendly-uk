...
Ireland and Northern Ireland (100 regions). A single static HTML page (no framework,
...
| `dog-friendly-uk-listings.csv` | 1,050 starter listings (100 county-level regions), ready for Supabase's CSV import |
...
5. Click **Import**. You should now see **1,050 rows**.
