...
create table if not exists public.listings (
  ...
  name           text      not null,
  category       text      not null check (category in ('pub', 'beach', 'trail', 'dog_park', 'toilet', 'accommodation', 'restaurant', 'campsite')),
...
alter table public.listings add constraint listings_category_check
  check (category in ('pub', 'beach', 'trail', 'dog_park', 'toilet', 'accommodation', 'restaurant', 'campsite'));
